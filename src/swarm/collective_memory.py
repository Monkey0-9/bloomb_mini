...
class SignalMemory:
    ...
    # Prediction accuracy
    prediction_correct: Optional[bool] = None  # Did signal direction match return?
...
class CollectiveMemory:
    ...
    def update_outcome(self, 
                      ...
                      forward_return_1d: Optional[float] = None,
                      forward_return_5d: Optional[float] = None,
                      forward_return_21d: Optional[float] = None) -> None:
        """
...
# Singleton
_memory: Optional[CollectiveMemory] = None
