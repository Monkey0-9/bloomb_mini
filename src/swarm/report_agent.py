...
class ReportAgent:
    ...
    def generate_report(self, 
                       ...
                       historical_data: Optional[Dict[str, Any]] = None) -> SignalReport:
        """
        ...
        report = SignalReport(
            report_id=f"rpt_{signal_id}_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}",
...
""".strip()
    ...
    def _analyze_historical_context(self,
                                    ticker: str,
                                    signal: Dict[str, Any],
                                    historical: Optional[Dict]) -> Dict[str, Any]:
    ...
    def _assess_contagion_risk(self, graph: Optional[Dict]) -> str:
    ...
    def _calculate_confidence_metrics(self,
                                     ...
                                     graph: Optional[Dict]) -> Dict[str, float]:
...
# Singleton
_agent: Optional[ReportAgent] = None
