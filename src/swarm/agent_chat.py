...
class ChatSession:
    ...
    session_id: str
    agent_name: Optional[str]  # None = chat with full swarm
    ticker: str
...
class AgentChatSystem:
    ...
    def create_session(self,
                      ...
                      ticker: str,
                      signal_id: Optional[str] = None) -> ChatSession:
        """Create a new chat session."""
        session_id = f"chat_{ticker}_{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}"
    ...
    def _generate_welcome(self, agent_name: Optional[str], ticker: str) -> str:
...
"""
    ...
    def _explain_reasoning(self, agent_name: Optional[str], ticker: str) -> str:
...
Kelly criterion suggests 2.4% position sizing for this edge. Sharpe ratio of historical trades: 1.8."""
    ...
    def _discuss_risks(self, agent_name: Optional[str], ticker: str) -> str:
...
QuantQuentin suggests position sizing at 50% of Kelly to account for uncertainty."""
    ...
    def _discuss_confidence(self, agent_name: Optional[str]) -> str:
    ...
    def _discuss_data(self, agent_name: Optional[str], ticker: str) -> str:
...
- Sector peers showing similar thermal upticks"""
    ...
    def _discuss_dissent(self, agent_name: Optional[str], ticker: str) -> str:
...
The swarm respects his dissent but the 4-1 vote suggests the evidence favors the bullish interpretation."""
    ...
    def _default_response(self, agent_name: Optional[str], ticker: str) -> str:
...
# Singleton
_chat_system: Optional[AgentChatSystem] = None
