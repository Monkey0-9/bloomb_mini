...
class SatellitePass:
    ...
    cloud_cover_forecast: Optional[float]  # % if available
...
class ThermalSignalTiming:
    ...
    optimal_imaging_window: Optional[Tuple[datetime, datetime]]
...
class OrbitalPassPredictor:
    ...
    def __init__(self):
        ...
        self._tle_timestamp: Optional[datetime] = None
    ...
    def predict_pass(self, 
                     ...
                     lat: float, 
                     lon: float,
                     hours_ahead: int = 72) -> Optional[SatellitePass]:
        """
    ...
    def get_cloud_cover_forecast(self, lat: float, lon: float) -> Optional[float]:
        """
...
# Singleton instance
_predictor: Optional[OrbitalPassPredictor] = None
