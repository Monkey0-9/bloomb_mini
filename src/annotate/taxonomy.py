...
PORT_THROUGHPUT_TAXONOMY = Taxonomy(
    ...
    classes=[
        ClassDefinition(
            1,
            "container_stack",
            "Stacked shipping containers on dock",
            (255, 100, 0),
            min_area_px=25,
        ),
        ClassDefinition(
            2, "vessel_at_berth", "Ship docked at a berth/pier", (0, 100, 255), min_area_px=100
        ),
        ClassDefinition(
            3,
            "empty_berth",
            "Berth/pier without any docked vessel",
            (200, 200, 200),
            min_area_px=50,
        ),
        ClassDefinition(
            4,
            "crane_active",
            "Gantry crane engaged in loading/unloading",
            (255, 255, 0),
            min_area_px=20,
        ),
        ClassDefinition(
            5,
            "truck_queue",
            "Queue of trucks waiting at port gate/yard",
            (150, 50, 50),
            min_area_px=30,
        ),
        ClassDefinition(
            6, "vessel_anchored", "Ship at anchor outside berth area", (0, 50, 200), min_area_px=80
        ),
        ClassDefinition(
            7,
            "yard_equipment",
            "RTG/straddle carrier/forklift in container yard",
            (100, 200, 100),
            min_area_px=15,
        ),
    ],
...
RETAIL_FOOTFALL_TAXONOMY = Taxonomy(
    ...
    classes=[
        ...
        ClassDefinition(
            3, "loading_dock", "Commercial loading/unloading bay", (255, 150, 0), min_area_px=30
        ),
        ClassDefinition(
            4,
            "pedestrian_zone",
            "Walkway/sidewalk area with foot traffic",
            (0, 255, 150),
            min_area_px=20,
        ),
        ClassDefinition(
            5, "truck", "Commercial truck/delivery vehicle", (150, 0, 200), min_area_px=15
        ),
    ],
...
INDUSTRIAL_OUTPUT_TAXONOMY = Taxonomy(
    ...
    classes=[
        ClassDefinition(
            ...
            "Heat plume from active smokestack/vent (visible in thermal)",
            (255, 0, 0),
            min_area_px=20,
        ),
        ClassDefinition(
            2,
            "thermal_plume_inactive",
            "Smokestack/vent with no visible thermal plume",
            (100, 100, 100),
            min_area_px=20,
        ),
        ClassDefinition(
            3, "smokestack", "Industrial chimney/exhaust structure", (200, 100, 0), min_area_px=10
        ),
        ClassDefinition(
            4,
            "cooling_tower",
            "Cooling tower (natural or forced draft)",
            (0, 200, 200),
            min_area_px=30,
        ),
        ClassDefinition(
            5,
            "storage_tank",
            "Cylindrical storage tank (oil, gas, chemical)",
            (150, 150, 0),
            min_area_px=15,
        ),
        ClassDefinition(
            6,
            "conveyor_belt",
            "Material transport conveyor system",
            (100, 100, 200),
            min_area_px=10,
        ),
    ],
