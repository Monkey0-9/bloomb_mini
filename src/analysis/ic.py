...
class ICAnalyzer:
    ...
    def run_ic_pipeline(self, signals: pd.DataFrame, returns: pd.DataFrame) -> pd.DataFrame:
        """
        ...
        results = pd.DataFrame(
            {"spearman_ic": pd.Series(ic_results), "p_value": pd.Series(p_values)}
        )
